package team.asquad.base.utils.imageshowpickerview;
...
public class ImageShowPickerView extends LinearLayout {
    ...
    private void viewTypedArray(Context context, AttributeSet attrs) {
        ...
        mAddLabel = typedArray.getResourceId(R.styleable.ImageShowPickerView_add_label, R.drawable.ic_image_show_piceker_add);
        mDelLabel = typedArray.getResourceId(R.styleable.ImageShowPickerView_del_label, R.drawable.ic_image_show_piceker_del);
